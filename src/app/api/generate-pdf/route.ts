...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .field-value a {
    ...
    font-weight: 600;
    border-bottom: 1px solid #0e5fc4;
...
<body>
  ...
  <div class="page-body">
    ...
    <div class="section">
      ...
      <div class="fields">
        <div class="field">
          ...
          <div class="field-value"><a href="mailto:${reg.email}">${reg.email}</a></div>
        </div>
        <div class="field">
          <div class="field-label">Phone Number</div>
          <div class="field-value"><a href="tel:${reg.phone}">${reg.phone}</a></div>
        </div>
    ...
    <div class="disclaimer">
      <div class="disclaimer-text">
        ...
        For verification, scan the QR code or contact <a href="mailto:support@framemaxx.com">support@framemaxx.com</a> with tracking ID
        <strong>${reg.trackingId}</strong>.
        <div class="disclaimer-link-row">
          <a href="https://www.framemaxx.com">www.framemaxx.com</a>
        </div>
      </div>
    </div>
  ...
  <div class="footer-band">
    ...
    <div class="footer-right">
      <a href="https://www.framemaxx.com">www.framemaxx.com</a> &bull; Generated ${formatDate(reg.createdAt)} at ${formatTime(reg.createdAt)} &bull; Page 1 of 1
    </div>
  </div>
